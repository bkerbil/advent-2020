...
(deftest update-history-test
  (testing "update-history"
    (testing "should add turn to spoken number"
      ...
      (is (= {0 [1 4] 3 [2] 6 [3]} (update-history 0 4 {0 [1] 3 [2] 6 [3]})))
      (is (= {0 [1 4] 3 [2 5] 6 [3]} (update-history 3 5 {0 [1 4] 3 [2] 6 [3]})))
      (is (= {0 [1 4] 3 [5 6] 6 [3]} (update-history 3 6 {0 [1 4] 3 [2 5] 6 [3]})))
      (is (= {0 [1 4] 1 [7] 3 [5 6] 6 [3]} (update-history 1 7 {0 [1 4] 3 [5 6] 6 [3]})))
      (is (= {0 [4 8] 1 [7] 3 [5 6] 6 [3]} (update-history 0 8 {0 [1 4] 1 [7] 3 [5 6] 6 [3]})))
      (is (= {0 [4 8] 1 [7] 3 [5 6] 4 [9] 6 [3]} (update-history 4 9 {0 [4 8] 1 [7] 3 [5 6] 6 [3]})))
      (is (= {0 [8 10] 1 [7] 3 [5 6] 4 [9] 6 [3]} (update-history 0 10 {0 [4 8] 1 [7] 3 [5 6] 4 [9] 6 [3]}))))))

(deftest speak-test
  (testing "speak"
    (testing "known state changes"
      (let [turn-3 {:last-spoken 6, :last-turn 3, :history {0 [1], 3 [2], 6 [3]}}
            turn-4 {:last-spoken 0, :last-turn 4, :history {0 [1 4], 3 [2], 6 [3]}}
            turn-5 {:last-spoken 3, :last-turn 5, :history {0 [1 4], 3 [2 5], 6 [3]}}
            turn-6 {:last-spoken 3, :last-turn 6, :history {0 [1 4], 3 [5 6], 6 [3]}}
            turn-7 {:last-spoken 1, :last-turn 7, :history {0 [1 4], 1 [7], 3 [5 6], 6 [3]}}
            turn-8 {:last-spoken 0, :last-turn 8, :history {0 [4 8], 1 [7], 3 [5 6], 6 [3]}}
            turn-9 {:last-spoken 4, :last-turn 9, :history {0 [4 8], 1 [7], 3 [5 6], 4 [9], 6 [3]}}
            turn-10 {:last-spoken 0, :last-turn 10, :history {0 [8 10], 1 [7], 3 [5 6], 4 [9], 6 [3]}}]
